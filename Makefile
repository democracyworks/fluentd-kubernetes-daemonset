...
IMAGE_NAME := 009999273940.dkr.ecr.us-west-2.amazonaws.com/democracyworks/fluentd-kubernetes-daemonset
X86_IMAGES := \
	v1.12/debian-azureblob:v1.12.1-debian-azureblob-1.0,v1.12-debian-azureblob-1 \
	v1.12/debian-elasticsearch7:v1.12.1-debian-elasticsearch7-1.0,v1.12-debian-elasticsearch7-1,v1-debian-elasticsearch \
	v1.12/debian-elasticsearch6:v1.12.1-debian-elasticsearch6-1.0,v1.12-debian-elasticsearch6-1 \
	v1.12/debian-loggly:v1.12.1-debian-loggly-1.0,v1.12-debian-loggly-1 \
	v1.12/debian-logentries:v1.12.1-debian-logentries-1.0,v1.12-debian-logentries-1 \
	v1.12/debian-cloudwatch:v1.12.1-debian-cloudwatch-1.3,v1.12-debian-cloudwatch-1 \
	v1.12/debian-stackdriver:v1.12.1-debian-stackdriver-1.0,v1.12-debian-stackdriver-1 \
	v1.12/debian-s3:v1.12.1-debian-s3-1.0,v1.12-debian-s3-1 \
	v1.12/debian-syslog:v1.12.1-debian-syslog-1.0,v1.12-debian-syslog-1 \
	v1.12/debian-forward:v1.12.1-debian-forward-1.0,v1.12-debian-forward-1 \
	v1.12/debian-gcs:v1.12.1-debian-gcs-1.0,v1.12-debian-gcs-1 \
	v1.12/debian-graylog:v1.12.1-debian-graylog-1.0,v1.12-debian-graylog-1 \
	v1.12/debian-papertrail:v1.12.1-debian-papertrail-1.0,v1.12-debian-papertrail-1 \
	v1.12/debian-logzio:v1.12.1-debian-logzio-1.0,v1.12-debian-logzio-1 \
	v1.12/debian-kafka:v1.12.1-debian-kafka-1.0,v1.12-debian-kafka-1 \
	v1.12/debian-kafka2:v1.12.1-debian-kafka2-1.0,v1.12-debian-kafka2-1 \
	v1.12/debian-kinesis:v1.12.1-debian-kinesis-1.0,v1.12-debian-kinesis-1

#	<Dockerfile>:<version>,<tag1>,<tag2>,...

ARM64_IMAGES := \
	v1.12/arm64/debian-azureblob:v1.12.1-debian-azureblob-arm64-1.2,v1.12-debian-azureblob-arm64-1 \
	v1.12/arm64/debian-elasticsearch7:v1.12.1-debian-elasticsearch7-arm64-1.3,v1.12-debian-elasticsearch7-arm64-1,v1-debian-elasticsearch-arm64 \
	v1.12/arm64/debian-elasticsearch6:v1.12.1-debian-elasticsearch6-arm64-1.0,v1.12-debian-elasticsearch6-arm64-1 \
	v1.12/arm64/debian-loggly:v1.12.1-debian-loggly-arm64-1.0,v1.12-debian-loggly-arm64-1 \
	v1.12/arm64/debian-logentries:v1.12.1-debian-logentries-arm64-1.0,v1.12-debian-logentries-arm64-1 \
	v1.12/arm64/debian-cloudwatch:v1.12.1-debian-cloudwatch-arm64-1.3,v1.12-debian-cloudwatch-arm64-1 \
	v1.12/arm64/debian-stackdriver:v1.12.1-debian-stackdriver-arm64-1.0,v1.12-debian-stackdriver-arm64-1 \
	v1.12/arm64/debian-s3:v1.12.1-debian-s3-arm64-1.0,v1.12-debian-s3-arm64-1 \
	v1.12/arm64/debian-syslog:v1.12.1-debian-syslog-arm64-1.0,v1.12-debian-syslog-arm64-1 \
	v1.12/arm64/debian-forward:v1.12.1-debian-forward-arm64-1.0,v1.12-debian-forward-arm64-1 \
	v1.12/arm64/debian-gcs:v1.12.1-debian-gcs-arm64-1.0,v1.12-debian-gcs-arm64-1 \
	v1.12/arm64/debian-graylog:v1.12.1-debian-graylog-arm64-1.0,v1.12-debian-graylog-arm64-1 \
	v1.12/arm64/debian-papertrail:v1.12.1-debian-papertrail-arm64-1.0,v1.12-debian-papertrail-arm64-1 \
	v1.12/arm64/debian-logzio:v1.12.1-debian-logzio-arm64-1.0,v1.12-debian-logzio-arm64-1 \
	v1.12/arm64/debian-kafka:v1.12.1-debian-kafka-arm64-1.0,v1.12-debian-kafka-arm64-1 \
	v1.12/arm64/debian-kafka2:v1.12.1-debian-kafka2-arm64-1.0,v1.12-debian-kafka2-arm64-1 \
	v1.12/arm64/debian-kinesis:v1.12.1-debian-kinesis-arm64-1.0,v1.12-debian-kinesis-arm64-1
